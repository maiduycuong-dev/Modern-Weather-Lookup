...
const i18n = {
    en: {
        ...
        lang: "Languages",
        historyTitle: "Select Past Date (Up to 2 Months)",
        today: "Today",
    ...
    vi: {
        ...
        lang: "Ngôn ngữ",
        historyTitle: "Chọn Ngày Quá Khứ (Tối đa 2 tháng)",
        today: "Hôm nay",
        selectHour: "Chọn giờ:",
    ...
    fr: {
        ...
        lang: "Langues",
        historyTitle: "Sélectionner une date (2 mois)",
        today: "Aujourd'hui",
    ...
    de: {
        ...
        lang: "Sprachen",
        historyTitle: "Datum auswählen (2 Monate)",
        today: "Heute",
    ...
    ru: {
        ...
        lang: "Языки",
        historyTitle: "Выбрать дату (2 месяца)",
        today: "Сегодня",
